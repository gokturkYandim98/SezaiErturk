// Translation data for Dr. Sezai Ertürk Website
const translations = {
    tr: {
        // Meta & Navigation
        page_title: "Op. Dr. Sezai Ertürk - Kadın Doğum Uzmanı | Alanya",
        page_description: "Op. Dr. Sezai Ertürk - Alanya'da kadın hastalıkları, doğum, jinekolojik estetik ve gebelik takibi hizmetleri",
        nav_home: "Anasayfa",
        nav_about: "Hakkımda",
        ...
        topic1: "İkili, Üçlü, Dörtlü Test Taramaları",
        topic2: "NIPT (Non-invaziv Prenatal Test)",
        topic3: "Karın İçi Ultrason Muayenesi",
        topic4: "Vajinal Ultrason Muayenesi",
        topic5: "Endometrial Biyopsi",
        topic6: "Servikal Biyopsi",
        topic7: "NST (Fetüs Takip Cihazı)",
        topic8: "Fraksiyonel Lazer Genital Estetik",
        ...
        // Topics Page (Services)
        topics_page_title: "Hizmetlerimiz",
        topics_page_description: "Kadın hastalıkları ve doğum ile ilgili detaylı bilgiler - Op. Dr. Sezai Ertürk",
        topics_page_subtitle: "Kliniğimizde sunduğumuz tedavi ve hizmetler",
        topics_categories: "Hizmet Kategorileri",
        topic_item1: "Gebelik ve Doğum",
        topic_item2: "Jinekolojik Muayene",
        topic_item3: "Kısırlık Tedavileri",
    ...
    en: {
        // Meta & Navigation
        page_title: "Op. Dr. Sezai Ertürk - Gynecologist & Obstetrician | Alanya",
        page_description: "Op. Dr. Sezai Ertürk - Women's health, gynecology, obstetrics, genital aesthetics and pregnancy monitoring services in Alanya",
        nav_home: "Home",
        nav_about: "About",
        ...
        topic1: "Double, Triple, Quadruple Test Screenings",
        topic2: "NIPT (Non-invasive Prenatal Test)",
        topic3: "Abdominal Ultrasound Examination",
        topic4: "Vaginal Ultrasound Examination",
        topic5: "Endometrial Biopsy",
        topic6: "Cervical Biopsy",
        topic7: "NST (Fetal Monitoring Device)",
        topic8: "Fractional Laser Genital Aesthetics",
        ...
        // Topics Page (Services)
        topics_page_title: "Our Services",
        topics_page_description: "Detailed information about gynecology and obstetrics - Op. Dr. Sezai Ertürk",
        topics_page_subtitle: "Treatments and services offered at our clinic",
        topics_categories: "Service Categories",
        topic_item1: "Pregnancy and Delivery",
        topic_item2: "Gynecological Examination",
        topic_item3: "Infertility Treatments",
    ...
    ru: {
        // Meta & Navigation
        page_title: "Оп. Др. Сезай Эртюрк - Гинеколог и Акушер | Алания",
        page_description: "Оп. Др. Сезай Эртюрк - Услуги по охране женского здоровья, гинекологии, акушерству, генитальной эстетике и мониторингу беременности в Алании",
        nav_home: "Главная",
        nav_about: "О враче",
        nav_services: "Услуги",
        nav_clinic: "Клиника",
        ...
        topic1: "Двойной, тройной, четверной скрининговые тесты",
        topic2: "НИПТ (Неинвазивный пренатальный тест)",
        topic3: "Абдоминальное ультразвуковое исследование",
        topic4: "Вагинальное ультразвуковое исследование",
        topic5: "Эндометриальная биопсия",
        topic6: "Цервикальная биопсия",
        topic7: "НСТ (Устройство мониторинга плода)",
        topic8: "Фракционная лазерная генитальная эстетика",
        ...
        // Topics Page (Services)
        topics_page_title: "Наши услуги",
        topics_page_description: "Подробная информация о гинекологии и акушерстве - Оп. Др. Сезай Эртюрк",
        topics_page_subtitle: "Лечение и услуги, предлагаемые в нашей клинике",
        topics_categories: "Категории услуг",
        topic_item1: "Беременность и роды",
        topic_item2: "Гинекологический осмотр",
        topic_item3: "Лечение бесплодия",
    ...
    de: {
        ...
        // Topics Page (Services)
        topics_page_title: "Unsere Dienstleistungen",
        topics_page_description: "Detaillierte Informationen über Gynäkologie und Geburtshilfe - Op. Dr. Sezai Ertürk",
        topics_page_subtitle: "Behandlungen und Dienstleistungen unserer Klinik",
        topics_categories: "Dienstleistungskategorien",
        topic_item1: "Schwangerschaft und Geburt",
        topic_item2: "Gynäkologische Untersuchung",
        topic_item3: "Unfruchtbarkeitsbehandlungen",
